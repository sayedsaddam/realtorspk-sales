...
<head>
    ...
    <title>
        <?php if($session == 'realtors' || $session == 'yasir.ali' || $session == 'akbar.arbab' || $session == 'shahana.farah' || $session == 'nasir.jalil'){ echo 'Leader Board | Realtors PK'; }else{ echo 'Login | Realtors PK'; } ?>
    </title>
</head>
<body>
    ...
    <div class="container-fluid">
        <?php if($session == 'realtors' || $session == 'yasir.ali' || $session == 'akbar.arbab' || $session == 'shahana.farah' || $session == 'adil.hussain' || $session == 'nasir.jalil'): ?>
