...
<head>
    ...
    <title>
        <?php if($session){ echo 'Sales Summary > Kohat | Daily Sales'; } ?>
    </title>
</head>
    <body>
            ...
            <div class="row mb-2">
                <div class="col-7">
                    <h2 class="font-weight-bold">
                        <?php if($session){ echo "Sales Summary &raquo; Kohat"; }else{ echo "Login"; } ?>
                    </h2>
                </div>
        ...
        <?php if($session == 'daily_sales.peshawar' || $session == 'daily_sales.kohat'): ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-sm">
                                            ...
                                            <tbody>
                                                <?php if(!empty($daily_sales_kohat)): $class = 0; foreach($daily_sales_kohat as $ds_kohat): $class++; ?>
                                                <tr class="<?php if($class == 1){ echo 'table-success'; } ?>">
                                                    <td><?= $ds_kohat->emp_name; ?></td>
                                                    <td><?= number_format($ds_kohat->revenue_target/1000000, 1).' mn'; ?></td>
                                                    <td><?= number_format($ds_kohat->received_amount/1000000, 2).' mn'; ?></td>
                                                </tr>
