...
<head>
    ...
    <title>
        <?php if($session ){ echo 'Sales Summary > Peshawar | Daily Sales'; } ?>
    </title>
</head>
    <body>
            ...
            <div class="row mb-2">
                <div class="col-7">
                    <h2 class="font-weight-bold">
                        <?php if($session){ echo "Sales Summary &raquo; Peshawar | <small>Amounts in Millions.</small>"; }else{ echo "Login"; } ?>
                    </h2>
                </div>
        ...
        <?php if($session == 'daily_sales.peshawar'): ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table class="table table-sm">
                                                ...
                                                <tbody>
                                                    <?php if(!empty($daily_sales_psh)): $serial = 0; foreach($daily_sales_psh as $ds_psh): ?>
                                                    <?php if($ds_psh->emp_team == 1 || $ds_psh->emp_team == 2 || $ds_psh->emp_team == 3 || $ds_psh->emp_team == 4 || $ds_psh->emp_team == 14): $serial++; ?>
                                                    <tr class="<?php if($serial == 1){ echo 'table-success'; } ?>">
                                                        <td><?= $ds_psh->emp_name; ?></td>
                                                        <td><?= number_format($ds_psh->revenue_target/1000000, 1); ?></td>
                                                        <td><?= number_format($ds_psh->received_amount/1000000, 2); ?></td>
                                                    </tr>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table class="table table-sm">
                                                ...
                                                <tbody>
                                                    <?php if(!empty($daily_sales_psh)): $class = 0; foreach($daily_sales_psh as $ds_psh): ?>
                                                    <?php if($ds_psh->emp_team == 5 || $ds_psh->emp_team == 6 || $ds_psh->emp_team == 12 || $ds_psh->emp_team == 13 || $ds_psh->emp_team == 15): $class++; ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <table class="table table-sm">
                                                ...
                                                <tbody>
                                                    <?php if(!empty($daily_sales_psh)): $class = 0; foreach($daily_sales_psh as $ds_psh): ?>
                                                    <?php if($ds_psh->emp_team == 11 || $ds_psh->emp_team == 19 || $ds_psh->emp_team == 20): $class++; ?>
                                                    <tr class="<?php if($class == 1){ echo 'table-success'; } ?>">
                                                        <td><?= $ds_psh->emp_name; ?></td>
                                                        <td><?= number_format($ds_psh->revenue_target/1000000, 1); ?></td>
                                                        <td><?= number_format($ds_psh->received_amount/1000000, 2); ?></td>
