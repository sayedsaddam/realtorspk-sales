    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-lg-8 col-md-8">
                <h1 class="display-4 font-weight-bold">Reporting Panel |<small style="font-size: 20px;"><a
                            class="text-light" href="javascript:history.go(-1);">Back</a></small></h1>
                <p class="text-justify">
                    You're logged in as: <strong><?= $this->session->userdata('fullname'); ?></strong><br><a
                        class="text-white" href="<?= base_url('admin/logout'); ?>" title="Click to sign out.">Sign
                        Out</a>
                </p>
            </div>
            <div class="col-xl-lg-4 col-md-4 text-right text-light">
                <a href="<?= base_url('admin/dashboard'); ?>"
                    class="btn btn-outline-light btn-lg btn-block">Dashboard</a>
            ...
            <table class="table table-sm">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php if($agent_report[0]->emp_name == $agent_report[0]->bdm_name){ echo '6,000,000'; }elseif($agent_report[0]->emp_name == $agent_report[0]->team_lead){ echo '10,000,000'; }else{ echo '3,000,000'; } ?>
                        </td>
                    </tr>
                    <tr>
                        <th>Office</th>
            ...
            <table class="table table-sm">
                <tbody>
                    <tr>
                        ...
                        <th>Location</th>
                        <td><?php if($project_report[0]->project == '091 Mall' || $project_report[0]->project == 'AH Towers' || $project_report[0]->project == 'Florenza'){ echo 'Peshawar'; }elseif($project_report[0]->project == 'MoH'){ echo 'Hangu'; }elseif($project_report[0]->project == 'North Hills'){ echo 'Murree'; }elseif($project_report[0]->project == 'AH City'){ echo 'D. I Khan'; } ?>
                        </td>
                    </tr>
                    <tr>
                        <th>No. of Sales</th>
            ...
            customize: function(win) {
                ...
                for (let i = 0; i < cols.length; i++) {
                    if (i < 2) {
                        ...
                        customFooter +=
                            '<th>' + columnSum +
                            '</th>'; // Display the sum in the footer
                    }
                }
                customFooter += '</tr></tfoot>';
                // Append the customized footer
                $(win.document.body).find('table').append(customFooter);
                ...
                //         customFooter +=
                //             '<th>' + footers[cols[i]] +
                //             '</th>'; // Customize this part as needed
                //     }
                // }
                // customFooter += '</tr></tfoot>';
                // // Append the customized footer
