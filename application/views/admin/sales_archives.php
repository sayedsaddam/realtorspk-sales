...
<div class="container">
    <div class="row mb-4">
        <div class="col-xl-lg-10 col-md-10 col-sm-10 col-print-12">
            <h2 class="font-weight-bold">Sales Report of <span class="text-secondary text-success px-2 py-2 rounded"><?= $_GET['archive_city']; ?></span> from <span class="text-secondary text-success px-2 py-2 rounded"> <?= date('F d, Y', strtotime($_GET['date_from'])).' <span class="text-dark">to</span> '.date('F d, Y', strtotime($_GET['date_to'])); ?></span></h2>
        </div>
                ...
                <table class="table table-hover table-sm">
                    <thead>
                        <tr>
							...
							<th>AH Tower</th>
							<th>AH City</th>
                            <th title="In all projects">Total Amount</th>
                        </tr>
                    </thead>
                    <tbody id="archives">
                        <?php   $serial = 1; 
