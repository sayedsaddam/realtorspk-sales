<?php if(empty($daily_sales) && empty($teams_report_hangu) && empty($monthly_commissions_hangu)): ?>
...
<?php exit; endif; ?>
<!-- Hangu sales -->
<?php if(empty($monthly_commissions_hangu)): ?>
<div class="container">
    <div class="row mt-3 d-print-none">
        <div class="col-7 text-center">
            <form action="<?=base_url('admin/filter_by_month_hangu');?>" method="get">
    ...
    <div class="row no-gutters mt-3">
        <div class="col-xl-lg-12 col-md-12">
            <h3 class="font-weight-light text-center">S2S Office, Hangu | <small class="font-weight-light"> <?= date('F, Y'); ?></small></h3>
            <div class="row">
                <div class="col-xl-col-lg-12 col-md-12 col-sm-12 table-responsive">
                    <table class="table table-sm">
                        ...
                        <tbody>
                            <?php if(!empty($teams_report_hangu)): $serial = 1;
                                    $total_targets_assigned = 0;
                                    $total_targets_achieved = 0;
                                    $total_targets_teams = 0;
                                    foreach($teams_report_hangu as $tr): ?>
                                <tr>
...
<?php elseif(!empty($monthly_commissions_hangu)): ?>
    <div class="container">
        <div class="row mt-3 d-print-none">
            <div class="col-7 text-center">
                <form action="<?=base_url('admin/filter_by_month_hangu');?>" method="get">
        ...
        <div class="row no-gutters mt-3">
            <div class="col-xl-lg-12 col-md-12">
                <h3 class="font-weight-bold text-light text-center">Teams Rebate - Hangu | <small class="font-weight-light"> For the month of <?= date('F, Y', strtotime($_GET['month'])); ?></small></h3>
                <div class="row">
                    <div class="col-xl-col-lg-12 col-md-12 col-sm-12 table-responsive">
                        <table class="table table-sm">
                            <thead>
                            ...
                            <tbody>
                            <?php if(!empty($monthly_commissions_hangu)): $serial = 1;
                                    $total_targets_assigned = 0;
                                    $total_targets_achieved = 0;
                                    $total_targets_teams = 0;
                                    foreach($monthly_commissions_hangu as $tr): if($tr->emp_city == 'Hangu'): ?>
                                <tr>
                                    <td><?= $serial++; ?></td>
                                    <td><?= $tr->team_name; ?></td>
                                    <td>
                                ...
                                <tr><td colspan="5" class="bg-dark"></td></tr>
                                <tr>
                                    <td class="font-weight-bold" colspan="2">Total</td>
                                    <td class="font-weight-bold"><?php if(!empty($total_targets_teams)){ echo number_format($total_targets_teams/1000000, 2); } ?></td>
                                    <td class="font-weight-bold"><?php if(!empty($total_targets_achieved)){ echo number_format($total_targets_achieved/1000000, 2); } ?></td>
...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-12">
            <h3 class="font-weight-light text-center">Teams Rebate (BDMs) - Hangu</h3>
            <table class="table tabel-striped table-sm">
                <thead>
                    <th>Sr#</th>
                    <th>BDM & Team</th>
                    <th>Target</th>
                    <th>Revenue</th>
                    <th>%age</th>
                    <th title="Applicable rebate/commission...">Applicable</th>
                </thead>
                <tbody>
                    <?php if(!empty($teams_report_hangu)): $serial = 1;
                        $total_targets_assigned = 0;
