<div class="jumbotron jumbotron-fluid text-white d-print-none" style="background-color: purple;">
    <div class="container">
        <div class="row">
            <div class="col-xl-lg-7 col-md-7">
                <h1 class="display-4 font-weight-bold">Sales Report |<small style="font-size: 20px;"><a
                            class="text-light" href="javascript:history.go(-1);">Back</a></small></h1>
                <p class="text-justify">
                    Welcome: <strong><?= $this->session->userdata('fullname'); ?></strong><br><a class="text-white"
                        href="<?= base_url('admin/logout'); ?>" title="Click to sign out.">Sign Out</a>
                </p>
            </div>
            <div class="col-xl-lg-5 col-md-5 text-right text-light">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select name="team" class="form-control">
                                ...
                                <option value="<?= $team->team_id; ?>"><?= $team->team_name.' - '.$team->team_lead; ?>
                                </option>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 table-responsive">
            ...
            <p class="text-center">Sales Report for agent having employee code
                <strong><?php echo $_GET['agent']; ?></strong>
                for dates
                <strong><?= date('M d, Y', strtotime($_GET['date_from'])).' - '.date('M d, Y', strtotime($_GET['date_to'])); ?></strong>
            </p>
            <?php endif; ?>
            <table class="table table-hover table-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="8" align="center"><button class="btn btn-primary d-print-none"
                                onclick="javascript:window.print();">Print Report</button></td>
                    </tr>
