...
class Admin_model extends CI_Model{
    ...
    // Get daily sales and display them on the website's front - dynamic.
    public function get_daily_sales($city){
        $this->db->select(
        ...
        $this->db->where(array('employees.emp_city' => $city, 'target_month' => date('F, Y')));
        $this->db->like('daily_sales.rec_date', date('Y-m'));
